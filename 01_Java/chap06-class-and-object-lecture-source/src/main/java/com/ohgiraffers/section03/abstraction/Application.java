...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *
        * 객체지향 프로그래밍이란
        * 현실세계의 모든 사건(event)는 객체와 객체의 상호작용에 의해 일어난다는 세계관을 프로그램을 만들 때
        ...
        * 본인의 상태를 스스로 제어하고 행동하도록 한다는 것이 현실 세계와는 다른점이다.(캡슐화의의미)
        ...
        * */
        ...
        /*
        * 객체와 객체의 상호작용이란?
        * 객체와 객체는 메세지를 통해 서로 상호작용을 한다. 메세지(메소드 호출)를 보내는 쪽을 송신자라고하고
        * 메세지를 수신하는쪽을 수신자라고한다.
        ...
        * 설계하는 것을 의미한다.
        *
        * 필드보다는 메소드를 중점으로 추상화기법을 적용하여 객체를 설계하고 그 객체를 구현하는 방법으로 설계한 대로
        ...
        * 1. 카레이서 클래스
        *   - 속성 : 자동차
        *   - 행위 : 시동을 걸어라, 엑셀레이터를 밟아라, 브레이클 밟아라, 시동을꺼라.
        * 2. 자동차 클래스
        *   - 속성 : 시동상태, 현재시속

...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        * int   i
        * Member member
        * 클래스 레퍼런스 변수 = new 클래스명(); <- 이전까지는 이렇게 써서 사용을 했다.
        *
        * ==> 클래스 레퍼런스 변수 = new 생성자();
        *
        ...
        *
        * 생성자란?
        * 인스턴스를 생성할 떄 초기 수행할 명령이 있는 경우 미리 작성해두고, 인스턴스를 생성할 떄 호출된다.
        * 생성자 함수에 매개변수가 없는 생성자를 기본생성자(default constructor)라고 하며,
        *
        * 기본생성자는 comiler에 의해 자동으로 추가되기 때문에 지금까지 명시적으로 작성하지 않고 사용할 수 있었다.
        *
        *
